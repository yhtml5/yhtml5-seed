    ...
    return (
      <div className="page-content">
        <Breadcrumb separator="/">
          ...
          <Breadcrumb.Item>新增服务</Breadcrumb.Item>
        </Breadcrumb>
        <section className="section">
          <Form>
            ...
            <FormItem {...formItemLayout} label="父级名称" hasFeedback>
              {getFieldDecorator('parent_id',{rules:[{required: true, message: '请选择父级名称'}]})(
            ...
            <FormItem {...formItemLayout} label="服务图标">
              {getFieldDecorator('img_url', {
                ...
                <Upload action="http://up.qiniu.com/" data={{token:uploadToken,key:this.state.name,file:this.state.files}} onPreview={this.handlePreview.bind(this)} listType="picture-card" beforeUpload={this.beforeUpload.bind(this)}>
