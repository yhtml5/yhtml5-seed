...
let ns = NameSpace('serveManagerUpdate');
...
export const SERVERSHOW_REQUEST = ns('SERVERSHOW_REQUEST');
export const SERVERSHOW_SUCCESS = ns('SERVERSHOW_SUCCESS');
export const SERVERSHOW_FAILED = ns('SERVERSHOW_FAILED');
...
export function serverShow(params,callback) {
    var defaultParam = {},
    params = Object.assign({}, defaultParam, params);
    params = JSON.stringify(params);
    return (dispatch) => {
        dispatch({
            type: SERVERSHOW_REQUEST,
            data: ''
        })
        Ajax({
            api: 'serverShow',
