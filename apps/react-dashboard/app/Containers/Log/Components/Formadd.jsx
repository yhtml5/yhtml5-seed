      ...
      <Form>
        ...
        <Form.Item label="日志标题" {...formItemLayout}>
          {this.props.form.getFieldDecorator('title', {
            ...
            <Input maxLength={20} placeholder="请输入日志标题"/>
          )}
        </Form.Item>
        ...
        <Form.Item label="日志主图" {...formItemLayout}>
        ...
        <Form.Item {...formItemLayout} label="日志内容" hasFeedback required>
        ...
        <Form.Item label="浏览量" {...formItemLayout}>
          {this.props.form.getFieldDecorator('view_num', {
            initialValue: this.props.view_num,
            rules: [
